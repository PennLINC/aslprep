...
from aslprep.niworkflows.interfaces.report_base import _SVGReportCapableInputSpec
...
class FSSurfaceReport(SimpleInterface):
    ...
    def _run_interface(self, runtime):
        from aslprep.niworkflows.viz.utils import plot_registration, cuts_from_bbox, compose_view
