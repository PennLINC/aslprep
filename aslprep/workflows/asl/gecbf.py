...
"""
    ...
    # fmt:off
    workflow.connect([
        (compute_cbf_wf, cbf_plot, [("outputnode.mean_cbf", "inputnode.cbf")]),
    ...
    workflow.connect([
        ...
        (compute_cbf_wf, compt_qccbf_wf, [("outputnode.mean_cbf", "inputnode.meancbf")]),
    ...
    workflow.connect([
        ...
        (compute_cbf_wf, cbfroiqu, [("outputnode.mean_cbf", "inputnode.cbf")]),
