...
def init_asl_grayords_wf(grayord_density, mem_gb, repetition_time, name="asl_grayords_wf"):
    """
...
""".format(
    ...
    select_std = pe.Node(
        KeySelect(fields=["asl_std"]), name="select_std", run_without_submitting=True, nohash=True
    )
    ...
    workflow.connect(
        [
            ...
            (inputnode, select_std, [("asl_std", "asl_std"), ("spatial_reference", "keys")]),
            (inputnode, select_fs_surf, [("surf_files", "surf_files"), ("surf_refs", "keys")]),
