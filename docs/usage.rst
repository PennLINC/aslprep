...
.. note:: 
     ...
     it is very  important to veryify these parameters with an MRI Physicist or someone who collected the data. 
     The conversion of ASL to BIDS on `flywheel <https://flywheel.io/>`_ can be done using `fw-heudiconv <https://fw-heudiconv.readthedocs.io>`_ 
