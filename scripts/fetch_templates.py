#!/usr/bin/env python
"""
Standalone script to facilitate caching of required TemplateFlow templates for ASLPrep.

To download and view how to use this script, run the following commands inside a terminal:
1. wget https://raw.githubusercontent.com/PennLINC/aslprep/main/scripts/fetch_templates.py
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Helper script for pre-caching required templates to run ASLPrep',
    )
    parser.add_argument(
        '--tf-dir',
